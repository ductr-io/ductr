...
module Rocket
  ...
  #
  #   class MyScheduler < Rocket::Scheduler
  ...
  class Scheduler
    ...
    def find_trigger(trigger_type, adapter_name = nil)
      return find_or_create_trigger(Rocket.trigger_registry, trigger_type) unless adapter_name

      trigger_registry = Rocket.config.adapter(adapter_name).class.trigger_registry
